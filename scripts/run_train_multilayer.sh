...
#SBATCH --output=./logs/multilayer_output_%j.slurmlog
#SBATCH --error=./logs/multilayer_error_%j.slurmlog
...
python "$SCRIPT_PATH" "$INPUT_PATH" --epochs 1000 --hidden_sizes 512 256 128 --dropout_rate 0.4 --learning_rate 0.0001
