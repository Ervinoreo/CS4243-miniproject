...
def validate_model(model_path, data_yaml_path, img_size=640):
...
def main():
    ...
    # Configuration
    DATA_YAML = "/home/e/ervin/cv4243-working/miniproject/CAPTCHA.v1-v1.yolov8/data.yaml"
    ...
    if results is not None:
        ...
        val_results = validate_model(best_model_path, DATA_YAML, IMG_SIZE)
