#!/usr/bin/env python3
"""
Character-Level MLP Model for CAPTCHA Recognition
This script implements an MLP model to classify individual characters, then aggregates them for CAPTCHA-level evaluation.
"""
...
class CharacterMLP(nn.Module):
    """MLP Model for Individual Character Classification"""
    ...
    def __init__(self, num_classes=36, img_size=32):
        ...
        input_size = img_size * img_size  # 32 * 32 = 1024
...
class CharacterTrainer:
    """Training class for Character MLP"""
...
def main():
    ...
    print("=== Character-Level MLP Model (PyTorch) ===")
    ...
    # Build model
    print("\nBuilding model...")
    model = CharacterMLP(num_classes=processor.num_classes)
    ...
    with open('./test_results.txt', 'w', encoding="utf-8") as f:
        f.write("Character-Level MLP Test Results\n")
        f.write("="*40 + "\n\n")
